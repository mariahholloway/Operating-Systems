//recieved help from shane oliver and amira crump
...
int my_comparer(const void *this, const void *that)
{
  ...
  else { //assuming priorities are now equal
...
int main(int argc, char *argv[])
{
	...
	/* Parse the input */
	/*******************/
	FILE *input_file = fopen(argv[1], "r"); //opens file for reading
	if (!input_file) {
	...
	/* sort the input  */
	/*******************/
	Comparer process_comparer = &my_comparer; //pointer
